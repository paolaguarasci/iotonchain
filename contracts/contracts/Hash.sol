...
contract Hash is Initializable {
    ...
    // Il doppio mapping e' necessario perche' questa carriola di linguaggio
    // su una key che non esiste restituisce un oggetto cmq valido
    // in questo caso (0, 0, "")
    // Questo mapping invece di default, per chiavi che non esistono, restituisce false.
